...
const Loader = () => {
  return (
    <StyledWrapper>
      <button disabled type="button" className="text-white  transform absolute translate-x-71 translate-y-80  inline-flex items-center">
        ...
        Loading...
        wait a moment api is free so it takes time
      </button>
    </StyledWrapper>
  );
}
